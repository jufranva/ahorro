                        ...
                        <div class="shop-top-bar-right">
                            ...
                            <div class="shop-short-by mr-4">
                                <select class="nice-select" aria-label=".form-select-sm example">
                                    ...
                                    <option value="3">Más Nuevo</option>
                                </select>
                            </div>
                    ...
                    <div class="row shop_wrapper grid_3">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product" data-aos="fade-up" data-aos-delay="200">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="single-product.html" class="image" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                                    ...
                                    <span class="badges">
										<span class="amarillo">50% de descuento</span>
                                    </span>
                                    <div class="actions">
                                ...
                                <div class="content">
                                    ...
                                    <div class="shop-list-btn">
                                        ...
                                        <button href="https://wa.me/593989818620" class="btn btn-sm btn-outline-dark btn-hover-primary">Preguntar</button>
