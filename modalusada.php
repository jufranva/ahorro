<!-- Modal Start  -->
    <div class="modalquickview modal fade" id="exampleModalusada" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    ...
                    <div class="col-md-6 col-12 overflow-hidden position-relative">
                        ...
                        <div class="product-summery">
                            ...
                            <div class="product-head mb-3">
                                <h2 class="product-title">Ropa usada</h2>
                            </div>
                            <!-- Product Head End -->

                            <!-- Price Box Start -->
                            <div class="price-box mb-2">
                                <span class="regular-price">$8220.00</span>
                                <span class="old-price"><del>$91230.00</del></span>
                            </div>
                            <!-- Price Box End -->
