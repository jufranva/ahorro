                        ...
                        <div class="product-inner">
                            ...
                            <!-- SKU End -->
                                ...
                                <div class="shop-list-btn">
                                    ...
                                    ?>
                                    <a href="<?= htmlspecialchars($waLink, ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-sm btn-info btn-hover-primary ms-1" title="Preguntar por esta prenda"><i class="pe-7s-help1"></i></a>
                                    <?php endif; ?>
                        ...
                        <nav>
                            <ul class="pagination">
                                ...
                                <li class="page-item<?= $prevDisabled; ?>">
                                    <a class="page-link" href="<?= $prevDisabled ? '#' : 'usada.php?' . $prevQuery; ?>" aria-label="Previous">
                                ...
                                ?>
                                    <li class="page-item"><a class="page-link<?= $page === $i ? ' active' : '' ?>" href="usada.php?<?= $pageQuery; ?>"><?= $i; ?></a></li>
                                <?php endfor; ?>
                                <?php
                                ...
                                <li class="page-item<?= $nextDisabled; ?>">
                                    <a class="page-link" href="<?= $nextDisabled ? '#' : 'usada.php?' . $nextQuery; ?>" aria-label="Next">
                        ...
                        <div class="product-summery">
                            ...
                            <div class="cart-wishlist-btn pb-4 mb-n3">
                                <div class="add-to_cart mb-3">
                                    ...
                                    $waLink = 'https://wa.me/593999591820?text=' . urlencode($waMessage);
                                    ?>
                                    <a class="btn btn-info btn-hover-primary ms-1" href="<?= htmlspecialchars($waLink, ENT_QUOTES, 'UTF-8'); ?>" title="Preguntar por esta prenda"><i class="pe-7s-help1"></i></a>
                                    <?php endif; ?>
                                    <?php $detailUrl = asset('prenda.php') . '?id=' . urlencode((string)$garment['id']); ?>
