                        ...
                        <div class="widget-list mb-10">
                            ...
                            <div class="sidebar-body">
                                <ul class="sidebar-list">
                                    ...
                                    <li><a href="usada.php?<?= http_build_query(array_filter(['category' => $cat['id'], 'sort' => $sort, 'perPage' => $perPage])) ?>"<?= $categoryId === (int)$cat['id'] ? ' class="active"' : '' ?>><?= htmlspecialchars($cat['name']); ?> (<?= $cat['usage_count']; ?>)</a></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                        </div>
